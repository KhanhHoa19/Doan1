...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1230, 680));
            ...
            .addGroup(AddTask_panelLayout.createSequentialGroup()
                ...
                .addGroup(AddTask_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(AddTask_panelLayout.createSequentialGroup()
                        ...
                        .addComponent(Date_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addGroup(AddTask_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(AddTask_panelLayout.createSequentialGroup()
        ...
        jLabel3.setText("Group todolist chat");
        ...
        Tasktable_panelLayout.setHorizontalGroup(
            ...
            .addGroup(Tasktable_panelLayout.createSequentialGroup()
                .addComponent(Time_label, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)
                .addGap(18, 18, 18)
    ...
    private void Date_tfKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Date_tfKeyTyped
        if(Date_tf.getText().length() == 2 || Date_tf.getText().length() == 5){
            Date_tf.setText(Date_tf.getText()+ "/");
        }
    }//GEN-LAST:event_Date_tfKeyTyped
    ...
    private void addtask_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addtask_btnMouseClicked
        if(Taskname_tf.getText().isEmpty() || Date_tf.getText().isEmpty()){
        ...
        model.addRow(new Object[] {Taskname_tf.getText(), Description_tf.getText(),Priority_cbb.getSelectedItem(), Date_tf.getText(), false});
        String text = "<html>Bạn đã thêm nhiệm vụ " + "<font color='red'>" + Taskname_tf.getText() +"</font>" + " với deadline vào " + "<font color='red'>" + Date_tf.getText() +"</font>" + "</html>";
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        javax.swing.Timer timer = new javax.swing.Timer(500, e -> {
            ...
            dispose();
            LoginFormClient mf = new LoginFormClient();
            mf.setVisible(true);
        });
