...
import sendfile.client.MainFormClient;
...
public class SendFile extends javax.swing.JFrame {
    ...
    public boolean prepare(String u, String h, int p, MainFormClient m){
        this.host = h;
        this.myusername = u;
        this.port = p;
        this.main = m;
    ...
    private void initComponents() {
        ...
        btnSendFile.setBackground(new java.awt.Color(0, 204, 204));
